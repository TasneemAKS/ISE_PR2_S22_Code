<?php 
  ...
  if(isset($_GET['update_students'])){
     ...
     $update_query = mysqli_query($conn, "UPDATE `student` SET wname = '$update_name_student', wGender = '$update_Gender', wdate = '$update_date', wage = '$update_number', wemail ='$update_email', wpassword = '$update_password' WHERE ID = '$update_id'");
				    ...
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     ...
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">تعديل معلومات الطالب</h2>
							 </div>
					     </div>
					   </div>
				      ...
				      ?>
					   ...
					   <div style ="display: inline-block; text-align: right; width: 70%"class="group">
						...
						<input type="text" name="update_name_student" value="<?php echo $row['wname']; ?>" style="text-align:right;" class="form-control">
