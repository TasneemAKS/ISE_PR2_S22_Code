<?php 
  ...
  if(isset($_GET["delet_activite"])){
    ...
    $edit_query = mysqli_query($conn, "SELECT * FROM `class` WHERE wid = $wid");
            while($row = $edit_query->fetch_assoc()){
    unlink('../picture/'.$row['wpicture']);
    }
			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <table class="table table-striped table-hover">
						...
						<?php
				          include('../connection.php');
				          $sql_subject = mysqli_query($conn,"SELECT * FROM activite " );
				        ...
				        ?>
						  ...
						  <tbody>
							<tr>
								...
								<td><img src="../picture/<?php echo $row['wpicture'] ?>" width="65"></td>
