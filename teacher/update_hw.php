<?php 
  ...
  if(isset($_GET['update_hm'])){
     $update_id = $_GET['update_id'];
     $update_name_class = $_GET['update_name_class'];
     $update_name_subject = $_GET['update_name_subject']; 

     $update_query = mysqli_query($conn, "UPDATE `hm` SET wnameclass = '$update_name_class', wnamesub = '$update_name_subject' WHERE wid = '$update_id'");
			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     ...
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">تعديل معلومات الوظيفة</h2>
							 </div>
					     </div>
					   </div>
				      ...
				      <?php
				        ...
				        if(isset($_GET['edit_hw'])){
				          $edit_id = $_GET['edit_hw'];
					...
					<div style ="display: inline-block; text-align: center; width: 70%">
						<input type="submit" value="تعديل" name="update_hm" class="btn btn-success"></div>
